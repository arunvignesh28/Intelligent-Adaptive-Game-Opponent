...
class InfoPane:
  ...
  def drawPane(self):
    ...
    self.sampleText = text( self.to_screen(0, 4*lineHeight),
                           color, 'SAMPLE SIZE:              0', DISPLAY_FONT, size, 'bold')


    linepos = 6*lineHeight
  ...
  def updateScore(self, state, busts):
    ...
    changeText(self.sampleText, "SAMPLE SIZE: % 14d" % state.sampleSize)
